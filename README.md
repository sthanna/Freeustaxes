...
FreeUsTaxes is a free, open-source tax filing application that can be used to file the Federal 1040 form. It is available in both [web](inprogress) and [desktop][desktop-releases] versions. It is provided free of charge and requires no sharing of personal data. FreeUsTaxes is build upon UsTaxes platform covering state tax filing for major states.
